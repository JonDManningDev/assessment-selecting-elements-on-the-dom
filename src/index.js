...
const ratings = document.querySelectorAll("div.rating > div.value");
...
*/
const halfStars = document.querySelectorAll("span.half");
...
*/
const established = document.querySelector("#ganp > div.stats > div.established > div.value");
